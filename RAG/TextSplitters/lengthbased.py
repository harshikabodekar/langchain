# we decide the chunk size based on the number of characters in the text. This is useful for text that has a lot of whitespace or other non-text characters that we want to ignore.
